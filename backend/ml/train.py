"""
Training script for the v9 step chart model.

Dense heads (onset / intensity / arrow-direction), no per-arrow / type /
duration / beat / hold heads. Composite val metric:
    0.70 * onset_tol_f1 + 0.20 * intensity_jump_auc + 0.10 * arrow_col_f1
...
def composite_score(metrics: Dict[str, float]) -> float:
    ...
    return 0.70 * onset + 0.20 * auc + 0.10 * arrow
