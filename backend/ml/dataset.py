...
random chunks for training. The model only consumes onset /
...
class StepChartDataset(Dataset):
    """
    Dataset of (feats_chunk, difficulty, density, onset_soft,
    ...
    def __getitem__(self, idx):
        ...
        # Build the per-song stream before slicing so chunks starting mid-note
